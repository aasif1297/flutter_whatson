...
import 'package:flutter_whatson/pages/EventDetailPage.dart';
...
class SlideViewState extends State<SlideView> with SingleTickerProviderStateMixin {
  ...
  List slideData;
  List<String> titles = ["The Technology Expo - Digital Innovation & Emerging Tech","Hustle Summit: The Most Epic Networking Event You'll Ever Attend","Mobile + Web Development Conference","Webinar: How to Create a More Productive Inside Sales Team with Better Data","2K19 Japan IT Week Sprint "];
        ...
        items.add(new GestureDetector(
          onTap: () {
            ...
            Navigator.of(context).push(new MaterialPageRoute(
                builder: (ctx) => new EventDetailPage(id: title)
            ));
          },
          child: new Stack(
            children: <Widget>[
